...
scatter!(r1D,zeros(size(r1D)),markersize=7,markercolor=:darkorange1,markerstrokecolor=:black,markerstrokewidth=2)
scatter!(zeros(size(r1D)),r1D,markersize=7,markercolor=:darkorange1,markerstrokecolor=:black,markerstrokewidth=2)
scatter!([0.0],[0.0],markersize=7,markercolor=:springgreen2,markerstrokecolor=:black,markerstrokewidth=2)
...
savefig("~/Desktop/LGL_spectral_elem_4.png")